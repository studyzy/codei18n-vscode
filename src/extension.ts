...
export function activate(context: vscode.ExtensionContext) {
    ...
    // Commands - Register commands regardless of enable state
    ...
    // Check if extension is enabled - only affects decoration/hover features
    ...
    const javaHoverProvider = vscode.languages.registerHoverProvider('java', new TranslationHoverProvider(commentService));
    context.subscriptions.push(javaHoverProvider);
    // Register Kotlin Hover Provider
    const kotlinHoverProvider = vscode.languages.registerHoverProvider('kotlin', new TranslationHoverProvider(commentService));
    context.subscriptions.push(kotlinHoverProvider);
    // Register Scala Hover Provider
    const scalaHoverProvider = vscode.languages.registerHoverProvider('scala', new TranslationHoverProvider(commentService));
    context.subscriptions.push(scalaHoverProvider);
}
